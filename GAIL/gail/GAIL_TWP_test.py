...
env = GAIL_TWP_Env(env_args.time_length, env_args.machine_state_dim, env_args.task_state_dim
                      ...
                      'IRL_TWP/traj_500_test/', None, cold_start=False)

filename = 'IRL_TWP/GAIL/gail/assets/learned_models/gail_experiment_0726.p'
...
with open('error_pickle_100_20000','wb') as f:
