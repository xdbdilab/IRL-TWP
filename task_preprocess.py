...
chunkSize = 2 ** 21
original_path = '/27T/TE_TWP/batch_task_query.csv'
MACHINE_NUM = 4034
...
for i in range(1, 4034):
    ...
    print(machine_name)
    task_path = '/27T/TE_TWP/machine_tasks/' + machine_name + '_task.csv'
    ...
    print(df.head(1))
    print(df.tail(1))
    save_path = '/27T/TE_TWP/machine_tasks_with_resource/' + machine_name + \
