...
from TESE_dataset import TaskDataset
...
writer = SummaryWriter('runs/gru_20-20')


train_set = TaskDataset('IRL_TWP/task_usage_pickle/', 0, 1200000)
test_set = TaskDataset('IRL_TWP/task_usage_pickle/', 1200000, 1300000)
...
for epoch in range(40):
    ...
    for i, (x, y) in enumerate(train_loader, 0):
        ...
        if i % 1000 == 999:  # print every 100 mini-batches
            ...
            running_loss = 0.0
            pickle.dump(net, open('task_usage_model_0723-{}.p'.format(epoch), 'wb'))
